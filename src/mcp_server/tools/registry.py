...
from mcp_server.tools.detail import (
...
def register_tools(server: FastMCP, service: WellnessService) -> None:
    @server.tool(name="get_legal_district_codes")
    ...
    @server.tool(name="search_wellness_by_area")
    ...
    @server.tool(name="search_wellness_by_location")
    ...
    @server.tool(name="search_wellness_by_keyword")
    ...
    @server.tool(name="get_wellness_sync_list")
    ...
    @server.tool(name="get_wellness_common_info")
    ...
    @server.tool(name="get_wellness_intro_info")
    ...
    @server.tool(name="get_wellness_repeating_info")
    ...
    @server.tool(name="get_wellness_images")
